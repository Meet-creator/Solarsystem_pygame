...
def main():
	...
	jupiter = Planet("Jupiter", 5.2 * Planet.AU, 0, 24, JUPITER, 1.898 * 10**27)
	jupiter.y_vel = -13.06 * 1000

	saturn = Planet("Saturn", 9.5 * Planet.AU, 0, 20, SATURN, 5.683 * 10**26)
	saturn.y_vel = 9.68 * 1000

	uranus = Planet("Uranus", 19.8 * Planet.AU, 0, 18, URANUS, 8.681 * 10**25)
	uranus.y_vel = 6.80 * 1000

	neptune = Planet("Neptune", 30 * Planet.AU, 0, 17, NEPTUNE, 1.024 * 10**26)
